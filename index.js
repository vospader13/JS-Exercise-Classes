...
class Car {
  ...
  drive(distance){
    ...
    let remainingFuel = this.tank * this.milesPerGallon;
    remainingFuel = distance;
    this.tank = remainingFuel / this.milesPerGallon;
...
//   constructor(name, age, location, argument){
//     super(name, age)
...
class ProjectManager extends Instructor {
  constructor({name, age, location, gradClassName, favInstructor}) {
    super({name, age, location, gradClassName, favInstructor})
